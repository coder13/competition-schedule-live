...
const foundDirname = !regularDirname && findSync(process.cwd(), [
    "../notifapi/prisma/generated/client",
    "notifapi/prisma/generated/client",
], ['d'], ['d'], 1)[0]
...
exports.Prisma.AuditLogScalarFieldEnum = makeEnum({
  id: 'id',
  action: 'action',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/cailyn/projects/competition-schedule-live/packages/notifapi/prisma/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "../notifapi/prisma/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../notifapi/prisma/generated/client/schema.prisma")
